...
class kkn_pop_module(models.Model):
    ...
    usage = fields.Selection(related='created_location.usage', string='Location Type', tracking=True)
    ...
    landlord_name = fields.Many2one('res.partner', string='Landlord Name', tracking=True)
    landlord_cnic = fields.Char(related='landlord_name.cnic', string='Landlord CNIC', tracking=True)
    landlord_mobile = fields.Char(related='landlord_name.mobile', string='Landlord Mobile', tracking=True)
    landlord_email = fields.Char(related='landlord_name.email', string='Landlord Email', tracking=True, required=False)
